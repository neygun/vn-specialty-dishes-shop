...
<div class="d-flex flex-row mb-3">
	<!-- Search box -->
	<form action="/admin/order/search" method="get" class="input-group p-2">
	...
	<div class="dropdown p-2">
	  ...
	  <ul class="dropdown-menu" aria-labelledby="dropdownorder">
		<li><a class="dropdown-item" href="/admin/order/status/pending">Chờ xác nhận</a></li>
		<li><a class="dropdown-item" href="/admin/order/status/shipping">Đang giao</a></li>
		<li><a class="dropdown-item" href="/admin/order/status/completed">Đã giao</a></li>
	  </ul>
	</div>
</div>
